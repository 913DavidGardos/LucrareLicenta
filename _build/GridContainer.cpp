...
void GridContainer::insert(int id, float centerX, float centerY)
{
	// calculate the index
...
void GridContainer::remove(int id)
{
...
void GridContainer::update(std::map<int, std::shared_ptr<Particle>>& particles)
{
...
std::vector<int> GridContainer::query(int id)
{
...
int GridContainer::getRows()
{
	return rows;
}

int GridContainer::getCols()
{
	return cols;
}
